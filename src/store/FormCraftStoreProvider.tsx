...
const FormCraftStoreContext = createContext<StoreApi<FormStore> | null>(null);

export const FormCraftStoreProvider = ({ children }: PropsWithChildren) => {
      ...
      removeStep: (stepId) =>
        set((state) => ({
          schema: {
            ...state.schema,
            steps:
              state.schema.steps?.filter((step) => step.id !== stepId) || [],
          },
        })),
...
export function useFormCraftStoreApi() {
  return useContext(FormCraftStoreContext);
}

export const useFormCraftStoreActions = () =>
  useFormCraftStoreInContext((state) => state);

export const useFormCraftSchema = () =>
  useFormCraftStoreInContext((state) => state.schema);

export const useFormCraftCurrentStep = () =>
  useFormCraftStoreInContext((state) => state.currentStep);

export const useFormCraftSelectedField = () =>
